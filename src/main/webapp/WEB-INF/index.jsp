		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active" ><a
						href="bootm" target="mainframe" id="bootm" onload="jumpIndex()">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="userList" target="mainframe"> <i
									class="icon-double-angle-right"></i> 用户管理
							</a></li>
                            <li><a href="genreList" target="mainframe"> <i
									class="icon-double-angle-right"></i> 种类管理
							</a></li>
						   <li><a href="foodList" target="mainframe"> <i
									class="icon-double-angle-right"></i> 菜品管理	</a></li>
							<li><a href="orderList" target="mainframe"> <i
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="<%=basePath%>bootm"
